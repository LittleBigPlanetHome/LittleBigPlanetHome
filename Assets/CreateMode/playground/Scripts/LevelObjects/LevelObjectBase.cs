...
namespace LevelObjects
{
	public abstract class LevelObjectBase : MonoBehaviour
	{
		...
		protected virtual void Awake()
		{
			...
			//scuff
			GameObject.Find("SFX_SpawnObject").gameObject.GetComponent<AudioSource>().PlayOneShot(GameObject.Find("SFX_SpawnObject").gameObject.GetComponent<AudioSource>().clip);
			Shape = new Paths();
		}
